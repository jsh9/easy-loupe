"""Application identity and asset helpers for EasyLoupe."""
...
ASSET_PACKAGE = 'easy_loupe.ui.assets'
ICON_PNG = 'EasyLoupe.png'
ICON_SVG = 'EasyLoupe.svg'
ICON_ICNS = 'EasyLoupe.icns'
ICON_ICO = 'EasyLoupe.ico'


def _package_version() -> str:
    try:
        return package_version('easy-loupe')
...
def easy_loupe_icon() -> QIcon:
    """Return the packaged EasyLoupe app icon."""
    ...
    if sys.platform == 'win32':
        ...
        # "--icon" embeds the icon into EasyLoupe.exe, but the live taskbar
