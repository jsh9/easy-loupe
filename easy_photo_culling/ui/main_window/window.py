"""Public MainWindow class for easy-photo-culling."""
...
from easy_photo_culling.ui.main_window.build import MainWindowBuildMixin
from easy_photo_culling.ui.main_window.navigation import (
    MainWindowNavigationMixin,
)
from easy_photo_culling.ui.main_window.presentation import (
    MainWindowPresentationMixin,
)
from easy_photo_culling.ui.main_window.workflows import MainWindowWorkflowMixin
from easy_photo_culling.ui.theme import THEMES

if TYPE_CHECKING:
    from PySide6.QtCore import QThread

    from easy_photo_culling.ui.main_window.dialogs import OrganizerDialogResult
    from easy_photo_culling.ui.workers import (
        OperationWorker,
...
class MainWindow(
    ...
    def __init__(self) -> None:
        ...
        self.setWindowTitle('Easy Photo Culling')
